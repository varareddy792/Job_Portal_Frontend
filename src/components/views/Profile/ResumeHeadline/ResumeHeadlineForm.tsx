  ...
  return (
    <div className="h-full w-10/12">
      <div className="col-start-2 col-end-4">
        <h1 className=" text-xs mb-5 col-start-1 col-end-5"> It is the first thing recruiters notice in your profile. Write concisely what makes you unique and right person for the job you are looking for.
        </h1>
        <div className="col-start-1 col-end-4">
          <form id="my-form" onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-4">
              <textarea className="shadow-sm appearance-none border rounded-xl w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-40"
