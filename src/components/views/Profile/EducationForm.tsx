...
export default function ({closeDialog, educationDetails}:any) {  
  ...
  useEffect(() => {
    (async () => {
      ...
      if (Object.keys(educationDetails).length) {
    ...
    <div>
      ...
      <h1 className="text-lg font-medium text-gray-900">Add Education</h1>
            <div className="col-span-full mb-4">
              ...
              <div className="mt-1">
                <select onChange={handleChange} id="education" name="education" autoComplete="education-name" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                {
                    eductionType?.map((item:any) => <option>{item?.title}</option>)
                  }
                </select>
              </div>
            </div>
            ...
            <div className="col-span-full mb-4">
              ...
              <div className="mt-1">
                ...
                {
                    institute?.map((item:any) => <option>{item?.title}</option>)
                  }
                </select>
              </div>
            </div>
            ...
            <div className="col-span-full mb-4">
              ...
              <div className="mt-1">
                <select onChange={handleChange} id="specialization" name="specialization" autoComplete="specialization" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                  {
                    courses?.map((item:any) => <option>{item?.title}</option>)
                  }
                </select>
              </div>
            </div>
            ...
            <div className="col-span-full mb-4">
              ...
              <div className="mt-1">
                ...
                {
                    passOutYear?.map((item:any) => <option>{item?.title}</option>)
                  }
                </select>
              </div>
            </div>
            ...
            <div className="col-span-full mb-4">              
              ...
              <div className="mt-2">
                <input onKeyUp={handleChange} type="number" name="percentage" id="percentage" autoComplete="percentage" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
              </div>
            </div>
